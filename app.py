...
# Asegurar que Streamlit siempre se ejecute en Tema Oscuro (Dark Mode)
_streamlit_dir = pathlib.Path(".streamlit")
_streamlit_dir.mkdir(exist_ok=True)
_config_file = _streamlit_dir / "config.toml"
if not _config_file.exists() or '[theme]' not in _config_file.read_text(encoding='utf-8'):
    _config_file.write_text('[theme]\nbase = "dark"\n', encoding='utf-8')
